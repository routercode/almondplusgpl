...
ifneq ($(CONFIG_BIG_ENDIAN),)
  JFFS2OPTS     :=  $(JFFS2_PAD) --big-endian --squash -v
else
  JFFS2OPTS     :=  $(JFFS2_PAD) --little-endian --squash -v
endif
...
ifneq ($(CONFIG_TARGET_ROOTFS_TARGZ),)
  define Image/mkfs/targz
		$(TAR) -zcpf $(BIN_DIR)/$(IMG_PREFIX)-rootfs.tar.gz --numeric-owner --owner=0 --group=0 -C $(TARGET_DIR)/ .
  endef
endif
...
define Image/mkfs/prepare/default
	...
	chmod 4755 $(TARGET_DIR)/bin/busybox
