...
$(eval $(if $(NF_KMOD),$(call nf_add,IPT_CONNTRACK,CONFIG_NF_CONNTRACK_PROC_COMPAT, $(P_V4)nf_conntrack_proc_compat),))
...
$(eval $(call nf_add,IPT_IPOPT,CONFIG_NETFILTER_XT_MATCH_WEBSTR, $(P_XT)xt_webstr))
