...
define KernelPackage/leds-gpio
  ...
  DEPENDS:=@GPIO_SUPPORT
  KCONFIG:=CONFIG_NEW_LEDS=y CONFIG_LEDS_GPIO
...
define KernelPackage/ledtrig-gpio
  ...
  DEPENDS:=@GPIO_SUPPORT
  KCONFIG:=CONFIG_NEW_LEDS=y CONFIG_LEDS_TRIGGERS=y CONFIG_LEDS_TRIGGER_GPIO
...
define KernelPackage/ledtrig-morse
  ...
  KCONFIG:=CONFIG_NEW_LEDS=y CONFIG_LEDS_TRIGGERS=y CONFIG_LEDS_TRIGGER_MORSE
...
define KernelPackage/ledtrig-netdev
  ...
  KCONFIG:=CONFIG_NEW_LEDS=y CONFIG_LEDS_TRIGGERS=y CONFIG_LEDS_TRIGGER_NETDEV
...
define KernelPackage/ledtrig-netfilter
  ...
  KCONFIG:=CONFIG_NEW_LEDS=y CONFIG_LEDS_TRIGGERS=y CONFIG_NETFILTER_XT_TARGET_LED
...
define KernelPackage/ledtrig-timer
  ...
  KCONFIG:=CONFIG_NEW_LEDS=y CONFIG_LEDS_TRIGGERS=y CONFIG_LEDS_TRIGGER_TIMER
...
define KernelPackage/ledtrig-usbdev
  ...
  DEPENDS:=@USB_SUPPORT +kmod-usb-core
  KCONFIG:=CONFIG_NEW_LEDS=y CONFIG_LEDS_TRIGGERS=y CONFIG_LEDS_TRIGGER_USBDEV
