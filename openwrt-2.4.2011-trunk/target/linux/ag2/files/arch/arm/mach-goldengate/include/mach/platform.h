...
#else
/* FIXME: ASIC,DRAM 512M and QM cpu_banks is 7 */
...
#define GOLDENGATE_BAUD_230400		(UART_CLOCK / 230400)
#define GOLDENGATE_BAUD_115200		(UART_CLOCK / 115200)
#define GOLDENGATE_BAUD_57600		(UART_CLOCK / 57600)
#define GOLDENGATE_BAUD_38400		(UART_CLOCK / 38400)
#define GOLDENGATE_BAUD_19200		(UART_CLOCK / 19200)
#define GOLDENGATE_BAUD_14400		(UART_CLOCK / 14400)
#define GOLDENGATE_BAUD_9600		(UART_CLOCK / 9600)
