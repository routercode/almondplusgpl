...
// Language:         C
//
// Filename:         $Source: /auto/project/cvsroot/design/sw/platforms/g2-36/openwrt-2.4.2011-trunk/target/linux/ag2/files/drivers/cs752x/char/hw_random/cs75xx-rng/include/elphw_platform.h,v $
// Current Revision: $Revision: 1.1.1.1 $
// Last Updated:     $Date: 2011/08/10 01:19:26 $
// Current Tag:      $Name: R1_2_20_4 $
//
//-----------------------------------------------------------------------*/
...
static inline uint32_t user_read_reg(uint32_t * addr)
{
   return (*addr);
};

static inline void user_write_reg(uint32_t *addr, uint32_t data)
{
   *addr = (data);
};

#define ELPHW_READ_REG(addr)  user_read_reg(addr)
#define ELPHW_WRITE_REG(addr,data) user_write_reg(addr, data)
