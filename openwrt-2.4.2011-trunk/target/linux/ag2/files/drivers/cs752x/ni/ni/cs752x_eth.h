...
#undef BYPASS_FE
#define CS752X_MULTIQUEUE_SUPPORT	1
#endif
...
#define GE_PORT0_PHY_ADDR	0x01 /* GAMC-0 */
#define GE_PORT1_PHY_ADDR	0x02 /* GAMC-1 */
#define GE_PORT2_PHY_ADDR	0x03 /* GMAC-2 */
#else
#define GE_PORT0_PHY_ADDR	0x01 /* GAMC-0 */
#define GE_PORT1_PHY_ADDR	0x00 /* switch */
#define GE_PORT2_PHY_ADDR	0x02 /* GMAC-2 */
#endif
...
#define NI_MAC_PHY_RMII_100	5
#define NI_MAC_PHY_SSMII_100	7
...
typedef union {
	u32 bits32;
	struct bit_header_dma {
		u32 header_valid	: 1; /* bits 31:24 */
		u32 no_stuff		: 1; /* bits 23:20 */
		u32 no_crc		: 1; /* bits 19:16 */
		u32 dvoq		: 8; /* bits 15:15 */
		u32 bypass_cos		: 3; /* bits 14:14 */
		u32 mark		: 1; /* bits 13:11 */
		u32 cpu_ptp_flag	: 1; /* bits 10:3  */
		u32 pspid		: 4; /* bits 2:2   */
		u32 fwd_type		: 4; /* bits 1:1   */
		u32 TqFlag2		: 8; /* bits 0:0   */
	} bits;
}  ni_header_a_t;       
...
typedef union {
	...
	struct bit_header_xr {
		u32 next_link		: 12;/*  0 ~ 11 */
		u32 bytes_valid		: 4; /* 12 ~ 15 */
		u32 rsv2		: 12;/* 16 ~ 27 */
		u32 invalid_pkt_len	: 1; /* 28      */
		u32 error_flag		: 1; /* 29      */
		u32 hdr_a		: 1; /* 30      */
		u32 ownership		: 1; /* 31      */

#if 0
		unsigned long long reserved0	:32;
		u32 next_link			: 11;
		u32 bytes_valid			: 4;
		u32 reserved1			: 13;
		u32 invalid_pkt_len		: 1;
		u32 error_flag			: 1;
		u32 hdr_e			: 1;
		u32 own				: 1;
#endif
...
typedef struct {
	...
	dma_txdesc_t *curr_tx_desc;
	dma_txdesc_t *curr_finished_desc;
...
typedef struct ni_private {
	mac_info_t mac[GE_PORT_NUM];
	dma_swtxq_t swtxq[NI_DMA_LSO_TXQ_NUM];
	
	dma_addr_t xram_desc_base_dma;
	u32 xram_desc_base[XRAM_RX_INSTANCE + XRAM_TX_INSTANCE];
	...
	u8 neEnabled;
	struct net_device *dev[GE_PORT_NUM];
#ifdef CONFIG_INTR_COALESCING
