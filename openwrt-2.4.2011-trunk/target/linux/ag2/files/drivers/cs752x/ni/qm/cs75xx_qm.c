...
#ifdef CONFIG_CS752X_HW_INTERNAL_BUFFERS
...
#ifdef CONFIG_CS752X_HW_INTERNAL_BUFFERS_HALF_SIZE
...
#ifdef CONFIG_CS752X_HW_INTERNAL_BUFFERS_192_SIZE
...
#define QM_MEM_CFG_1GB		3
	...
	qm_cfg1.bf.cpu_banks = 7;	/* FPGA:HW QM use 16M, ASIC:64M */
	/*
	...
	/* ACP for QM */
#ifdef ACP_QM	
	writel(0x00000012, GLOBAL_ARM_CONFIG_E);
	 /* ACP remap register */
 	writel(0x20000000, QM_SPARE);
#endif	
}
