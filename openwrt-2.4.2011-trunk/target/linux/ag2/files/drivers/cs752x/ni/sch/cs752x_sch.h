...
#define CS_SCH_CPU_PORT1	(CPU_PORT0 + 1)
#define CS_SCH_CPU_PORT2	(CPU_PORT1 + 1)
#define CS_SCH_CPU_PORT3	(CPU_PORT2 + 1)
#define CS_SCH_CPU_PORT4	(CPU_PORT3 + 1)
#define CS_SCH_CPU_PORT5	(CPU_PORT4 + 1)
#define CS_SCH_CPU_PORT6	(CPU_PORT5 + 1)
#define CS_SCH_CPU_PORT7	(CPU_PORT6 + 1)
