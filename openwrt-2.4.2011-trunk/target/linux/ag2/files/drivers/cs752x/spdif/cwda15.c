...
void CWda15_StartClock(CWda15_Config_Type *InstancePtr, unsigned int sample_rate){
	...
	unsigned int clock = 0x046DC96E;	/* for 44.1K */
...
#else
	unsigned int clock = 0x011B725B;	/* for 44.1K */
...
#else
	if (InstancePtr->SampleFrequency > 0)
		CWda15_StartClock(InstancePtr, InstancePtr->SampleFrequency);
	else
