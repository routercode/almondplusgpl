...
in subsequent Cortina releases. Please use the custom-board-3.4.11 directory for this purpose instead.

This directory is picked up and applied by the OpenWRT build process AFTER
both NON-OpenWRT specific Linux are applied from patches-3.4.11 and then any Custom Board
patches found in custom-board-3.4.11.
...
in nature should be migrated to patches-3.4.11.
